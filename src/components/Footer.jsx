    ...
    <footer className="mt-24 border-t border-border bg-muted/40">
      <div className="mx-auto max-w-7xl px-4 py-14 md:px-6">
        <div className="grid gap-10 md:grid-cols-4">
          <div>
            <div className="flex items-center gap-2">
              <img src={logo} alt="Expertise Hub Foundation logo" className="h-10 w-10 object-contain" />
              <div className="flex flex-col leading-tight">
                <span className="font-display font-bold text-foreground text-sm">Expertise Hub</span>
                <span className="text-[10px] text-muted-foreground uppercase tracking-wider">Foundation</span>
              </div>
            </div>
            <p className="mt-4 text-sm text-muted-foreground italic">
              Building Skills, Powering Innovation, Transforming Northern Nigeria.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li><a href="#programs" className="text-muted-foreground hover:text-primary transition-smooth">Our Programs</a></li>
              <li><a href="#impact" className="text-muted-foreground hover:text-primary transition-smooth">Impact</a></li>
              <li><a href="#blog" className="text-muted-foreground hover:text-primary transition-smooth">News & Blog</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li><a href="#get-involved" className="text-muted-foreground hover:text-primary transition-smooth">Volunteer</a></li>
              <li><a href="#get-involved" className="text-muted-foreground hover:text-primary transition-smooth">Donate</a></li>
              <li><a href="#get-involved" className="text-muted-foreground hover:text-primary transition-smooth">Partner With Us</a></li>
        ...
        <div className="mt-12 border-t border-border pt-6 flex flex-col md:flex-row justify-between gap-3 text-xs text-muted-foreground">
          <p>© {new Date().getFullYear()} Expertise Hub Empowerment Foundation. All rights reserved.</p>
